...
$packageArgs = @{
  ...
  url           = 'https://github.com/ActivityWatch/activitywatch/releases/download/v0.8.1/activitywatch-v0.8.1-windows-x86_64.zip'
  checksum      = '7dc21b8f341749b3957ca2ea9394357163724531b730d2c0755cc81f0a53d28c'
  checksumType  = 'sha256'
}
