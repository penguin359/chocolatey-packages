...
function global:au_GetLatest {
    ...
    $remoteVersionCudatext = $doc.feed.entry.properties.version
    ...
    $remoteVersionCudatextBeta = $doc.feed.entry.properties.version -Replace '-beta', ''
    ...
    if ([System.Version]$versionBeta -gt [System.Version]$remoteVersionCudatextBeta) {
    ...
    } elseif ([System.Version]$version -gt [System.Version]$remoteVersionCudatext) {
