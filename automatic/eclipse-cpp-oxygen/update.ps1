...
function global:au_GetLatest {
    ...
    return @{ Version = $version ; URL32 = 'https://ftp.halifax.rwth-aachen.de/eclipse//technology/epp/downloads/release/' + $matches.VersionUrl + '/R/eclipse-cpp-' + $matches.VersionUrl + '-R-win32-x86_64.zip' }
}
