if ( [environment]::OSVersion.Version.Major -ge 10 )  {
  ...
  $url_others     = 'https://dnl.hamapps.com/JTAlert/HamApps_JTAlert_2.13.2_Setup.exe'
	$checksum_others= '88e4d491d5145307c2c036502b1bac8c11aac6895ad7ba2b28e6eeb497a22748'
  $url            = $url_others
