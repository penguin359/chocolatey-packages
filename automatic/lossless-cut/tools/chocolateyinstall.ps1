...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.33.1/LosslessCut-win.zip'
  checksum       = '6bc31939b157ffdf4be4027f438c027f4b324ed51fcafa6af0894ab0547609e7'
  checksumType   = 'sha256'
}
