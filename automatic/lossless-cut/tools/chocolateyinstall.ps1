...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.34.3/LosslessCut-win.zip'
  checksum       = '486eba7d740c009f004d75a20f35116f4be7fd1817bbc9cfe50f256e0cf87669'
  checksumType   = 'sha256'
}
