...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.31.1/LosslessCut-win.zip'
  checksum       = 'd809ccaea13bdc91d0bfdb333cbdcd8c087f403f0e0fcd4bb1af6c57e133e5d0'
  checksumType   = 'sha256'
}
