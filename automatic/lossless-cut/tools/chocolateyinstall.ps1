...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.25.0/LosslessCut-win.zip'
  checksum       = 'c69f570952bd3efa88fecaf8982969986206fd601529b3f8e43ba4fed5c0c635'
  checksumType   = 'sha256'
}
