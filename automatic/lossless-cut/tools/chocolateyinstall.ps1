...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.32.0/LosslessCut-win.zip'
  checksum       = '8ca8d3a7d159c7af8b5a5fa72bb30e11d54f4ab8986aa041533fff49937e5348'
  checksumType   = 'sha256'
}
