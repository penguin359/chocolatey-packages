...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.17.1/LosslessCut-win.zip'
  checksum       = '387c00faff136b5e28745d26dfd97c299399bf6e091114fc517a55e87b2ac759'
  checksumType   = 'sha256'
}
