...
$packageArgs = @{
  ...
  url            = 'https://github.com/mifi/lossless-cut/releases/download/v3.23.7/LosslessCut-win.zip'
  checksum       = '8f74bd30a26b6215b875242665ef501f713ba27888a865f4672292fa8e7c8ad1'
  checksumType   = 'sha256'
}
