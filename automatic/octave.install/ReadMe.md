# <img src="https://cdn.jsdelivr.net/gh/chtof/chocolatey-packages/automatic/octave.install/octave.install.png" width="48" height="48"/> [GNU Octave (Install)](https://chocolatey.org/packages/octave.install)
