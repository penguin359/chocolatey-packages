...
$url        = 'http://www.dxatlas.com/MorseRunner/Files/MorseRunner.zip' # download url, HTTPS preferred
$setupName  = 'setup.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'morse-runner*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
